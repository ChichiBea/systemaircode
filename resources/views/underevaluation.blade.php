...
<div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Submissions: Proponent: Under Evaluation</h1>
                    </div>

                    <!-- Page Heading -->
                    <!-- <h1 class="h3 mb-2 text-gray-800">Call for Proposals</h1>
                    <p class="mb-4">DataTables is a[
                        , ] third party plugin that is used to generate the demo table below.
